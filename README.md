...
`$Parser->setSepcialWhois('it' => array('server' => 'whois.nic.it', 'port' => 43, 'format' => '-u username -w passsword %domain%', 'template' => 'it-your-template'));`

ToDos
-----
Caching and optional Json output
...
Tested with following TLDs an RIRs
----------------------------------
Domain List by http://data.iana.org/TLD/tlds-alpha-by-domain.txt
