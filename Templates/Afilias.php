...
class Template_Afilias extends AbstractTemplate
{
    ...
    protected $blockItems = array(
            ...
            3 => array(
                    '/^(Admin|Administrative)(\-| )ID(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:handle', 
                    '/^(Admin|Administrative)(\-| )Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:name', 
                    '/^(Admin|Administrative)(\-| )Organization(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:organization', 
                    '/^(Admin|Administrative)(\-| )(Street|Address)[0-9]*(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:address', 
                    '/^(Admin|Administrative)(\-| )City(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:city', 
                    '/^(Admin|Administrative)(\-| )State\/Province(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:state', 
                    '/^(Admin|Administrative)(\-| )Postal(\-| )Code(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:zipcode', 
                    '/^(Admin|Administrative)(\-| )ZIP(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:zipcode', 
                    '/^(Admin|Administrative)(\-| )Country(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:country', 
                    '/^(Admin|Administrative)(\-| )Phone(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:phone', 
                    '/^(Admin|Administrative)(\-| )FAX(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:fax', 
                    '/^(Admin|Administrative)(\-| )(Email|E-Mail)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:admin:email'), 
            4 => array(
                    '/^Billing(\-| )ID(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:handle', 
                    '/^Billing(\-| )Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:name', 
                    '/^Billing(\-| )Organization(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:organization', 
                    '/^Billing(\-| )(Street|Address)[0-9]*(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:address', 
                    '/^Billing(\-| )City(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:city', 
                    '/^Billing(\-| )State\/Province(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:state', 
                    '/^Billing(\-| )Postal(\-| )Code(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:zipcode', 
                    '/^Billing(\-| )ZIP(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:zipcode', 
                    '/^Billing(\-| )Country(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:country', 
                    '/^Billing(\-| )Phone(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:phone', 
                    '/^Billing(\-| )FAX(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:fax', 
                    '/^Billing(\-| )(Email|E-Mail)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:billing:email'), 
            5 => array(
                    '/^(Tech|Technical)(\-| )ID(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:handle', 
                    '/^(Tech|Technical)(\-| )Name(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:name', 
                    '/^(Tech|Technical)(\-| )Organization(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:organization', 
                    '/^(Tech|Technical)(\-| )(Street|Address)[0-9]*(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:address', 
                    '/^(Tech|Technical)(\-| )City(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:city', 
                    '/^(Tech|Technical)(\-| )State\/Province(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:state', 
                    '/^(Tech|Technical)(\-| )Postal(\-| )Code(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:zipcode', 
                    '/^(Tech|Technical)(\-| )ZIP(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:zipcode', 
                    '/^(Tech|Technical)(\-| )Country(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:country', 
                    '/^(Tech|Technical)(\-| )Phone(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:phone', 
                    '/^(Tech|Technical)(\-| )FAX(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:fax', 
                    '/^(Tech|Technical)(\-| )(Email|E-Mail)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'contacts:tech:email'), 
            6 => array(
                    '/^(Name Server|Nameservers)(?>[\x20\t]*):(?>[\x20\t]*)(.+)$/im' => 'nameserver', 
